...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_9_EMPTY_SPORK) r = SPORK_9_EMPTY_SPORK_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_9_EMPTY_SPORK") return SPORK_9_EMPTY_SPORK;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_9_EMPTY_SPORK) return "SPORK_9_EMPTY_SPORK";
