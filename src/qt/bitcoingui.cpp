...
QFontDatabase::addApplicationFont(":/fonts/cntxcoin_font");

QString windowTitle = tr("CNTX") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/send")),  tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a CNTX address"));
    ...
    receiveCoinsAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/receiving_addresses")),tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CNTX: URIs)"));
    ...
    historyAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/history")), tr("&Transactions"), this);
    ...
    toolsAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/tools")), tr("&Settings"), this);
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/masternodes")), tr("&Masternodes"), this);
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CNTX wallet"), this);
    aboutAction->setStatusTip(tr("Show information about CNTX wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CNTX wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CNTX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/eye")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CNTX addresses"));
    ...
    openInfoAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/icon_info")), tr("&Information"), this);
    openInfoAction->setStatusTip(tr("Show diagnostic information"));
    openRPCConsoleAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/debugwindow")), tr("&Debug console"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging console"));
    openNetworkAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/icon_net")), tr("&Network Monitor"), this);
    openNetworkAction->setStatusTip(tr("Show network monitor"));
    openPeersAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/peers_list")), tr("&Peers list"), this);
    ...
    openAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/add")), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a CNTX: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/icon_info")), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CNTX help message to get a list with possible CNTX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CNTX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CNTX network", "", count));
}
...
{
    QString strTitle = tr("CNTX"); // default title
