...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, CMasternode* pmn)
{
    ...
    if (pmn) {
        ...
        switch (pmn->Level())
        {
            case 1: mnLevelText = "30 days"; if (roi1 > 1) tLuck = ((masternodeCoins/COIN) / roi1)*100; break;
            case 2: mnLevelText = "90 days"; if (roi2 > 1) tLuck = ((masternodeCoins/COIN) / roi2)*100; break;
            case 3: mnLevelText = "180 days"; if (roi3 > 1) tLuck = ((masternodeCoins/COIN) / roi3)*100; break;
        }
    }
