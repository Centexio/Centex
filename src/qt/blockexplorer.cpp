...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::CNTX, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (cntxcoin.conf).");
            QMessageBox::warning(this, "CNTX Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#333333; bgcolor:#CCDDF9;}\n a, span { font-family: monospace; }\n span.addr {color:#819AC8; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #CCDDF9;}\n td.d0 {font-weight: bold; color:#333333;}\n h2, h3 { white-space:nowrap; color:#819AC8;}\n a { color:#145484; text-decoration:none; }\n a.nav {color:#819AC8;}\n";
