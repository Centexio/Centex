...
/** Utility functions used by the cntxcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render cntxcoin addresses in monospace font
...
// Parse "cntxcoin:" URI into recipient object, return true on successful parsing
