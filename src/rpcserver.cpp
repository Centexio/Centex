...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cntx features */
        {"cntx", "masternode", &masternode, true, true, false},
        {"cntx", "listmasternodes", &listmasternodes, true, true, false},
        {"cntx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cntx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cntx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cntx", "masternodedebug", &masternodedebug, true, true, false},
        {"cntx", "startmasternode", &startmasternode, true, true, false},
        {"cntx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cntx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cntx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cntx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cntx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cntx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cntx", "mnsync", &mnsync, true, true, false},
        {"cntx", "spork", &spork, true, true, false},
        {"cntx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cntx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cntxcoind, or the -server option to cntxcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"cntx Alert\" admin@foo.com\n"),
...
{
    return "> cntxcoin-cli " + methodname + " " + args + "\n";
}
