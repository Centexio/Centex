...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CNTX Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cntxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cntxcoin transaction") + "\n" +
                               "  cntxcoin-tx [options] -create [commands]   " + _("Create hex-encoded cntxcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cntxcoin transaction
