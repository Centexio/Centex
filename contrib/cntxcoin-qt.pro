...
RESOURCES += src/qt/cntxcoin.qrc src/qt/cntxcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cntxcoin_bg.ts \
                src/qt/locale/cntxcoin_de.ts \
                src/qt/locale/cntxcoin_en.ts \
                src/qt/locale/cntxcoin_es.ts \
                src/qt/locale/cntxcoin_fi.ts \
                src/qt/locale/cntxcoin_fr.ts \
                src/qt/locale/cntxcoin_it.ts \
                src/qt/locale/cntxcoin_ja.ts \
                src/qt/locale/cntxcoin_pl.ts \
                src/qt/locale/cntxcoin_pt.ts \
                src/qt/locale/cntxcoin_ru.ts \
                src/qt/locale/cntxcoin_sk.ts \
                src/qt/locale/cntxcoin_sv.ts \
                src/qt/locale/cntxcoin_vi.ts \
                src/qt/locale/cntxcoin_zh_CN.ts \
                src/qt/locale/cntxcoin_zh_TW.ts
