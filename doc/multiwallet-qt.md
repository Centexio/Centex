...
In order to support loading of multiple wallets in cntxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cntxcoin.cpp.
...
Changes to cntxcoin.cpp
----------------------
cntxcoin.cpp is the entry point into cntxcoin-qt, and as such, will require some minor modifications to provide hooks for
