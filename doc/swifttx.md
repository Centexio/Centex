...
* WebSocket: [https://github.com/cntxcoin-Core/insight-api-cntxcoin#web-socket-api](https://github.com/cntxcoin-Core/insight-api-cntxcoin#web-socket-api)
* API: [https://github.com/cntxcoin-Core/insight-api-cntxcoin#swifttx-transactions](https://github.com/cntxcoin-Core/insight-api-cntxcoin#swifttx-transactions)
...
By default, the cntxcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the cntxcoin Core daemon:
