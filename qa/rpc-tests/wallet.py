...
#   c) node1 mines 32 blocks, so now node 0 has 60001 cntxcoin, node 1 has 4250 cntxcoin, node2 has none.
#   d) node0 sends 601 cntxcoin to node2, in two transactions (301 cntxcoin, then 300 cntxcoin).
